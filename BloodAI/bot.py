...
- If you're genuinely blocked on a decision only the user can make, use ask_user — it posts clickable options in a thread and waits for a real answer. Don't overuse it: decide things yourself whenever you reasonably can.
